...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Because the += operator uses the + concatenator which always creates
    # a new object. The << operator on the other hand just modifies the
    # original object.
  end
  ...
  in_ruby_version("1.9") do
    ...
    def test_in_ruby_1_9_you_can_get_a_single_character_from_a_string
      ...
      # Surprised?
      #
      # Not really. A string is just an array of characters,
      # hence why the shovel operator works as it does
    end
  end
