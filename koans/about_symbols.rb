...
class AboutSymbols < EdgeCase::Koan
  ...
  #
  # Because symbols are not garbage collected, they are added to the symbols
  # table. Therefore they will act as a memory leak if you continually add
  # them dynamically in your program.
end
